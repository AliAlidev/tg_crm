...
table.dataTable.table thead th.sorting:after, table.dataTable.table thead th.sorting_asc:after{
    top:17px!important;
}
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-4 col-md-5 col-8" >
            <h3 class="top-title">Leader board</h3>
        </div>
    </div>
    </div>
            ...
            <table class="table table-bordered table-hover" style="width: 200%" id="dataTable">
                <thead style="background: #70cacc;color: aliceblue;">
                    ...
                    <th><span class="table-title">id</span></th>
                        ...
                        <th><span class="table-title">Not answer</span></th>
                        <th><span class="table-title">Number unavailable/Not working for call/Incomplete no</span></th>
                        <th><span class="table-title">Switch off/Line busy/Wrong number/Invalid number</span></th>
                        <th><span class="table-title">Others</span></th>
                        <th><span class="table-title">Set appointment</span></th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
