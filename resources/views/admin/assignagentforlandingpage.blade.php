...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-5 col-md-6 col-11" >
            <h3 class="top-title">Assign agent for landing page</h3>
        </div>
    </div>
    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="agent" class="form-control filter mt-2"  id="agent">
                    ...
                    <div class="col-md-4 btn-center">
                        <button id="buttonsubmit" type="button" class="registerbtn">Assign</button>
                    </div>
                </div>                
            </div>
        </form>
