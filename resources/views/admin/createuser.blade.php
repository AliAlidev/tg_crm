...
#name,#email,#phone,#password,#password_confirm,#property,#language{
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-3 col-md-4 col-8" >
            <h3 class="top-title">Create new User</h3>
        </div>
    </div>
    </div>
        ...
        <form id="maindata">
            <div class="container">
                    ...
                    <select id ="property" name="role" class="form-control">
                        <option value="">Role</option>
                            @foreach ($roles as $role)
                                <option value="{{ $role->role_id }}">{{ ucfirst($role->name ) }}
                                </option>
                        @endforeach
                    </select>
                    </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Position"  name="position" id="property" >
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
