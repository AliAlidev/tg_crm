...
@push('head')
    <title>Assign imported data to agent</title>
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-7" >
            <h3 class="top-title">Assign imported data to agent</h3>
        </div>
    </div>
    </div>
            ...
            <div class="container-fluid" style="margin-top:1.5rem">
                ...
                <div id="parent" class="card shadow pb-5 mb-5">
                        ...
                        <div class="row pad-row2 mb-1">
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div id="tfoot3" class="col-md-5 col-12">
                                        ...
                                        style="right: -4px;" id="daymonthfilter"><img src="img/filter2.png" style="width: 100%"></span>
                                        <span id="border" >
                    ...
                    <div class="card-body mt-3">
                        <table class="table table-bordered table-hover" style="width: 550%" id="dataTable">
