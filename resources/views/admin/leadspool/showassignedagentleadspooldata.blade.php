...
@push('head')
    <title>Show assigned agent to leads pool data</title>
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-6 col-md-7 col-11" >
            <h3 class="top-title">Show assigned agent to leads pool data</h3>
        </div>
    </div>
    </div>
        ...
        $("div.dataTables_filter input").unbind();
            ...
            $('#unassign_data').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('unassign_agent_leads_pool_data') }}",
