...
@push('head')
    ...
    <style>
        #leadform {
            box-shadow: 0px 0px 4px 1px #184d476e;
            border: 1px solid #6c4d18;
            margin-top: 2rem;
            padding: 2rem 0;
            border-radius: 6px;
        ...
        .iti--allow-dropdown {
            ...
            border-bottom: 1px solid #6c4d18 !important;
        ...
        .reg-btn {
            ...
            width: 60%;
            margin: auto;
            background-color: #6c4d18 !important;
            border: none !important;
            font-size: 1rem;
            color: #fff;
        ...
        #buttonsubmit:hover {
            ...
            color: #6c4d18 !important;
            border: 1px solid #6c4d18 !important;
        }
            ...
            <form id="leadform">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <select id="select" class="form-input" name="source" required="">
