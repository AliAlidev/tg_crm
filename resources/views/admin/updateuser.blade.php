...
#property,#name,#email,#phone,#password,#password_confirm,#language{
        ...
        <form id="maindata">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="property">Role</label>
                    </div>
                    <div class="col-md-8">
                    <select id ="property" name="role" class="form-control">
                            @foreach ($roles as $role)
                                <option  @if($userrole == $role->id)  selected @else '' @endif value="{{ $role->role_id }}">{{ ucfirst($role->name ) }}
                                </option>
                            @endforeach
                    </select>
                    </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="file" name="image" id="property" >
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Position" value="{{$userposition}}"  name="position" id="property" >
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
