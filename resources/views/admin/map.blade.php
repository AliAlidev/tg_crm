...
<div id="map" style="height: 90vh; width: 100%;"></div>
    <div class="row" style="border: 1px solid #bfb2b2;background:#fff;width:100%;display: flex;align-items: center;height: 3.9rem;">
      <div style="width: 30%;text-align: center;" > <a style="background:#6d4e18;color:#fff;padding:.5rem 2rem;border-radius:0px;margin-top:0px;text-decoration:none;font-family: 'Lato-Regular'; font-weight: 200;font-size: 14px;"
