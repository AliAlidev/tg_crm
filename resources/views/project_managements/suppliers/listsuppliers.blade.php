    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-6">
                <h3 class="top-title">Show Suppliers</h3>
            </div>
        </div>
    </div>
        ...
        <div id="content">
            ...
            <div class="container-fluid" style="margin-top:1.5rem">
                ...
                <div id="parent" class="card shadow mb-4">
                    <div class=" pb-3 mt-3 mb-3 ml-3" role="alert" id="alertdiv" hidden>
                    </div>
                            ...
                            <table class="table table-bordered table-hover" id="dataTable">
                                <thead style="background: #70cacc;color: aliceblue;">
                                    <tr>
                                        ...
                                        <th><span class="table-title">Additional Mobile </span></th>
                                        <th><span class="table-title">Website Links </span></th>
                ...
                $('body').on('click', '.edit', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            window.location.href = "{{ route('editSupplier') }}/" +id;
                        },
                    });
                });
