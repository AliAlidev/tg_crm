    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-4 col-md-5 col-9">
                <h3 class="top-title">Create New Supplier</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata" class="mt-5">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input class="form-control ml-1" type="text" id="property" placeholder="Supplier Name"
                             name="name" >
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Supplier Mobile" name="mobile" id="property" >
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-8">
                        <input class="form-control" type="text" placeholder="Supplier Additional Mobile" name="additional_mobile"
                            id="property" >
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Supplier Website Links" name="website_links"
                            id="property">
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Supplier Address" name="address" id="property" >
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-md-12 text-center">
                        <button id="buttonsubmit" type="submit" class="registerbtn">Create Supplier</button>
                    </div>
                </div>
            </div>
        </form>
