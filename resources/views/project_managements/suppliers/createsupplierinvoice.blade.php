    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-4 col-md-5 col-9">
                <h3 class="top-title">Create New Supplier Invoices</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata" class="mt-5">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="file" placeholder="Supplier Invoice Image" name="image" id="property" >
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-8">
                        <input class="form-control" type="text" placeholder="Supplier Invoice Number" name="number"
                            id="property" >
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="number" placeholder="Supplier Invoice Advanced Payment" name="advanced_payment"
                            id="property">
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="number" placeholder="Supplier Invoice Total Payment" name="total_payment" id="property" >
                    </div>
                </div>
                <div class="row mt-5">
    ...
    <script>
        $(document).on('submit', '#maindata', function(e) {
            ...
            $.ajax({
                ...
                contentType: false,
                data: formData,
                url: "{{ route('storeSupplierinvoice') }}",
