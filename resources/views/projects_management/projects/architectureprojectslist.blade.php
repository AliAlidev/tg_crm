@extends('layouts.app')
@push('head')
    <title>Architecture Projects List</title>
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-5 col-md-5 col-10" >
            <h3 class="top-title">Architecture Projects List</h3>
        </div>
    </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('architecture_projects_list') }}",
                    "dataType": "json",
                    "type": "POST",
                    "data": function(d) {
                        return $.extend({}, d, {
            ...
            $('body').on('click', '.progress1', function() {
                ...
                $.ajax({
                    ...
                    url: "{{ route('projecttasks') }}/" + id,
                    success: function(result) {
                        window.location.href = "{{ route('project_progress_index') }}/" +id;
                    },
                });
            });
        });
