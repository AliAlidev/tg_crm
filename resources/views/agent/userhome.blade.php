                ...
                <div id="parent" class="card shadow pb-5 mb-5">
                    ...
                    <div class="card-body mt-2" style="overflow: auto">
                        ...
                        <!-- <div class="row mb-4 ml-5">
                            ...
                            <div class="col-md-2">
                                <input type="button" value="filter" class="btn btn-primary"
                                    style="font-size:.9rem;font-weight:bold" id="daymonthfilter">
                            </div> -->
                            ...
                            <div class="col-md-2">
                                <input type="button" value="filter range" class="btn btn-primary"
                                    style="font-size:.9rem;font-weight:bold" id="rangefilter">
                            </div>
                        </div> -->
                        ...
                        <div class="row mt-5 ml-5 mr-5 mb-5"> -->
                            {{-- <div class="col-md-4">
                                <select name="datasource" class="form-control filter" id="sel1"
                                    style="font-size:.9rem;font-weight:bold">
                        ...
                        <!-- <div class="row">
                            <h3 class="ml-5 mb-3" style="margin-left: 10%">Select Data</h3>
                        </div> -->
