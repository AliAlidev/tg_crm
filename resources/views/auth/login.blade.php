...
<head>
    ...
    <style>
      #log{background: #ab7b1f!important}
      .input-div.focus .i i{background:#ab7b1f!important}
      .input-div.focus::after, .input-div.focus::before{background: #ab7b1f!important}
      .input-div.focus .i i {
    color: #ab7b1f!important;
}
        </style>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="img">
            <img src="img/logo2.png" alt="" style="width: 15rem;">
        </div>
